...
const routes: Routes = [
  ...
  { path: 'obrigacoes', canActivate: [AuthGuard], loadChildren: () => import('./obrigacoes/obrigacoes-module').then(m => m.ObrigacoesModule) },
  { path: 'moradores', canActivate: [AuthGuard], loadChildren: () => import('./moradores/moradores-module').then(m => m.MoradoresModule) },
